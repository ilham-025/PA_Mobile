...
public class FindClassViewModel extends ViewModel {
    ...
    public void setListclass(RequestError requestError, String code){
        String url = "http://"+ Auth.ip +"/elearning/public/api/find-class?code="+code;
